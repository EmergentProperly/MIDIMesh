    ...
    def populate_device_list(self):
        try:
            ...
            for name, device_obj in self.current_device_list:
                # Safety check: Ensure name is a valid string for the Label
                if name is None:
                ...
                # Ensure text is a string (Kivy Label.text does not accept None)
            ...
            # If anything goes wrong during list population, log it and
            # show a generic error message instead of crashing the app.
