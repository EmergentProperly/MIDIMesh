...
class OctaveButton(Widget):
    ...
    def __init__(self, direction, octave_callback=None, **kwargs):
        ...
        self.normal_image = 'assets/octave-button.png'
        self.pressed_image = 'assets/octave-button-pressed.png'
    ...
    def on_touch_down(self, touch):
        ...
        if self.collide_point(*touch.pos):
            ...
            if self.midi_callback:
                self.midi_callback('note_on', self.note_value, 64)
            return True
        return False
...
class OnScreenKeyboards(Widget):
    ...
    def create_keyboard(self):
        ...
        oct_down = OctaveButton(
            ...
            size=(90, 298),
            pos=(self.x + padding - 10, self.y + padding)
        )
        white_keys.append(oct_down)
        ...
        oct_up = OctaveButton(
            ...
            octave_callback=self.change_octave,
            size=(90, 298),
            pos=(current_x + padding - 20 , self.y + padding)
        )
        white_keys.append(oct_up)
        ...
        for i, key in enumerate(white_note_keys):
            ...
            if has_sharp:
                ...
                black_key = OnScreenKey(
                    ...
                    midi_callback=self.send_midi,
                    size=black_key_size,
                    pos=(key.right - black_key_size[0] / 2, self.y + padding + (white_key_size[1] - black_key_size[1]))
                )
